...
import com.it10x.foodappgstav7_04.data.pos.dao.*
import com.it10x.foodappgstav7_04.data.pos.entities.*
import com.it10x.foodappgstav7_04.data.pos.entities.config.*
...
@Database(
    ...
    version = 84,              // ⬆️ increment version since schema changed
    exportSchema = true
)
